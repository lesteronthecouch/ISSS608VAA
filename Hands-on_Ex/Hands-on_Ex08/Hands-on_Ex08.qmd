...
## 22.4 Data Import and Preparation
...
## 22.5 Creating a sf data frame from an aspatial data frame
...
## 22.7 It all started with an interactive point symbol map
...
## 22.8 Lets make it proportional
...
## 22.9 Lets give it a different colour
...
Importing geospatial data in rds format into R environment. - Creating cartographic quality choropleth maps by using appropriate tmap functions. - Creating rate map - Creating percentile map - Creating boxmap \## 23.2 Getting Started \### 23.2.1 Installing and loading packages Your turn Using the steps you learned in previous lesson, install and load sf, tmap and tidyverse packages into R environment.
